...
1. Go to the **Assets** tab on a release
2. Click **Upload** or drag and drop files
3. Files are stored and linked to the release

### Google Drive integration

If your workspace has [Google Drive connected](/integrations/google-drive/):

1. Click **Browse Drive** in the Assets tab
...
File storage is limited by your subscription plan:

| Plan | Storage |
|------|---------|
| **Solo Lifetime** | 1 GB |
| **Label Lifetime** | 25 GB |
| **Agency / Pro Lifetime** | 100 GB |
